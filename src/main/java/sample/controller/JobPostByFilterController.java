 ...
 * @author Tranduc
 */
@WebServlet(name = "JobPostByFilterController", urlPatterns = {"/JobPostByFilterController"})
public class JobPostByFilterController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            for (CompanyDTO com : listCompany) {
                ...
                request.getRequestDispatcher("postByFilter.jsp").forward(request, response);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
    }
